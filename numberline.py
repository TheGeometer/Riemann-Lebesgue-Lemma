...
from manim.mobject.geometry import ArrowTriangleTip, ArrowSquareTip, ArrowSquareFilledTip,\
                                ArrowCircleTip, ArrowCircleFilledTip, ArrowTriangleFilledTip

from manim.mobject.geometry import ArrowTip
from manim.mobject.geometry import Polygon, Triangle
from abc import ABC
from manim.utils.color import WHITE
from typing import final


class CustomArrowTip(ArrowTip, Polygon, ABC):
	def __init__(self, **kwargs):
		Polygon.__init__(self, [0, height, 0], [-width, 0, 0], [0, 0, 0], [width, 0, 0])
		self.scale(0.15)
...
class NumberLine(Line):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.show_only_custom = show_only_custom
        # visuals
    ...
    def add_ticks(self):
        ...
        if self.show_only_custom == False:
